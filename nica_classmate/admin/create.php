...
if ($_POST) {
    ...
    if (empty($errors)) {
        $stmt = $pdo->prepare("INSERT INTO inquire (name, email, phone, budget, service_type, event_date, location, additional_services, message, referral) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$name, $email, $phone, $budget, $service_type, $event_date, $location, $additional_services, $message, $referral]);
...
<head>
    ...
    <title>Create Inquiry - Click by Nica</title>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            <div class="bg-green-50 px-6 py-4 border-b border-green-200">
                <h2 class="text-2xl font-bold text-green-900">New Inquiry Form</h2>
            ...
            <form method="POST" class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="tel" name="phone" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" value="<?php echo htmlspecialchars($_POST['phone'] ?? ''); ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="budget" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input type="text" name="referral" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" value="<?php echo htmlspecialchars($_POST['referral'] ?? ''); ?>">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="service_type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input type="date" name="event_date" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" value="<?php echo htmlspecialchars($_POST['event_date'] ?? ''); ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="location" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" value="<?php echo htmlspecialchars($_POST['location'] ?? ''); ?>">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="additional_services" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"><?php echo htmlspecialchars($_POST['additional_services'] ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="message" rows="4" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"><?php echo htmlspecialchars($_POST['message'] ?? ''); ?></textarea>
                </div>
                ...
                <div class="mt-6 flex justify-between">
                    ...
                    <button type="submit" class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700">
                        <i class="fas fa-save mr-2"></i>Create Inquiry
                    </button>
                </div>
            </form>
        </div>
